...
<link rel="stylesheet" type="text/css" media="all" href="style.css_v2">
...
<div id="logo" class="col-xl-1"><a href="index"><img src="img/logo_big.gif" alt="lunwing.com"></div></a>

<div id="menu" class="col-xs-8">
<ul class="row">
<a href="http://blog.lunwing.com"><li class="col-xs-3"><img src="img/blogger.gif"></li></a>
<a href="aboutme"><li class="col-xs-1 col-sm-3">About Me</li></a>
<a href="portfolio"><li class="col-xs-1 col-sm-3">Portfolio</li></a>
<a href="contactme"><li class="col-xs-1 col-sm-3">Contact Me</li></a>
</ul>
</div>
